...
## Who Is Hermione?
<Image width={300} class="post-image max-width-300 float-left" src={cover} alt="Hermione holding books and smiling in her Hogwarts school uniform" />
...
<Image class="post-image" src={hermione_slash_harry} alt="word cloud of stories summaries that have hermione/harry in them" loading="lazy"/>
#### Archetype
...
<Image class="post-image" src={hermione_friend_harry} alt="word cloud of stories summaries that have hermione and harry in them" loading="lazy"/>
</div>

<div>
### <a name="draco">Hermione/Draco - The Care Giver and the Trickster</a>
<Image class="post-image" src={hermione_slash_draco} alt="word cloud of stories summaries that have hermione/draco in them" loading="lazy" />
#### Archetype
...
<Image class="post-image" src={hermione_friend_draco} alt="word cloud of stories summaries that have hermione/draco in them" loading="lazy" />
</div>
...
<Image class="post-image" src={hermione_snape} alt="word cloud of stories summaries that have hermione/snape in them" loading="lazy" />
#### Archetypes
...
<Image class="post-image" src={hermione_tom} alt="word cloud of stories summaries that have hermione/tom riddle in them" loading="lazy" />
#### Archetypes
The following archetypes can be identified in the characters:
