...
## Who Is Hermione?
<Picture class="post-image max-width-300 float-left" src={cover} alt="Hermione holding books and smiling in her Hogwarts school uniform" />
Her primary traits are intelligence, a studious focus, anxiously adhering to authorities rules and strong motivation for ethical action. 
...
<Picture class="post-image" src={hermione_ron} alt="word cloud of stories summaries that have hermione/ron in them" loading="lazy"/>
...
<Picture class="post-image" src={hermione_slash_harry} alt="word cloud of stories summaries that have hermione/harry in them" loading="lazy"/>
#### Archetype
...
<Picture class="post-image" src={hermione_friend_harry} alt="word cloud of stories summaries that have hermione and harry in them" loading="lazy"/>
</div>

<div>
### <a name="draco">Hermione/Draco - The Care Giver and the Trickster</a>
<Picture class="post-image" src={hermione_slash_draco} alt="word cloud of stories summaries that have hermione/draco in them" loading="lazy" />
#### Archetype
...
<Picture class="post-image" src={hermione_friend_draco} alt="word cloud of stories summaries that have hermione/draco in them" loading="lazy" />
</div>
...
<Picture class="post-image" src={hermione_snape} alt="word cloud of stories summaries that have hermione/snape in them" loading="lazy" />
#### Archetypes
...
<Picture class="post-image" src={hermione_tom} alt="word cloud of stories summaries that have hermione/tom riddle in them" loading="lazy" />
#### Archetypes
The following archetypes can be identified in the characters:
